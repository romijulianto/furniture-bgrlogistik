...
<div class="container-fluid pt-1 pb-2">
	...
	<div class="row justify-content-center mt-4">
		<div class="col-5">
			<h3 class="text-center">*** BGR LOGISTIK ***</h3>
			<div id="header" class="mt-3">
				<span>KALIBESAR TIMUR NO 5-7, JAKARTA 11110</span><br>
				<span>Telepone: 02216916666</span><br>
				<span><em>www.bgrlogistik.id</em></span>
			</div>
			<div id="sub_header">
				<div class="row mt-3">
	      			<div class="col-md-3"><b>Kode Invoice</b></div>
				...
				<div class="row">
	      			<div class="col-md-3"><b>Cashier</b></div>
	      			<div class="col-xs-1"> : </div>
	      			<div class="col text-break"><em><?= $isi_menu_invoice[0]['nama_user']; ?></em></div>
	      			<div class="col text-right">
