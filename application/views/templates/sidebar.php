<div class="wrapper">
  ...
  <nav id="sidebar">
    ...
    <ul class="list-unstyled components">
      ...
      <li>
        ...
        <?php endif ?>
          ...
          <?php if ($dataUser['jabatan'] == 'superadmin'): ?>
            <li>
    ...
    <ul class="list-unstyled">
        <p><b>Organized by</b><br><em>R o m i  J u l i a n t o</em></br></p>
      </li>
    </ul>
  </nav>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <button type="button" id="sidebarCollapse" class="btn merah-baru">
          <i class="fas fa-align-left"></i> | Organized by <a href='https://www.linkedin.com/in/romijulianto/' title='github.com/romijulianto' target='_blank'>Romi Julianto</a>
